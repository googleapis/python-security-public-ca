...
from google.cloud.security.publicca_v1beta1.services.public_certificate_authority_service import PublicCertificateAuthorityServiceAsyncClient
from google.cloud.security.publicca_v1beta1.services.public_certificate_authority_service import PublicCertificateAuthorityServiceClient
from google.cloud.security.publicca_v1beta1.services.public_certificate_authority_service import transports
...
def test_create_external_account_key_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = resources.ExternalAccountKey.pb(return_value)
...
def test_transport_kind(transport_name):
    transport = PublicCertificateAuthorityServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
