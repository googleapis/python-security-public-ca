...
class PublicCertificateAuthorityServiceClient(metaclass=PublicCertificateAuthorityServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PublicCertificateAuthorityServiceTransport]] = None,
        ...
        if isinstance(transport, PublicCertificateAuthorityServiceTransport):
    ...
    def create_external_account_key(self,
        ...
        # in a service.CreateExternalAccountKeyRequest.
